...
describe("httputil", function()
    ...
    describe("headers", function()
        ...
        describe("parse_mutliargs", function()
            it("can parse mutli arguments", function()
                local result = headers.parse_mutliargs("gzip, inflate")
                assert.are.same({'gzip', 'inflate'}, result)
            end)
            it("can parse mutli arguments for header", function()
                local result = headers.parse_mutliargs({"Accept-Encoding","gzip, inflate"})
                assert.are.same({'gzip', 'inflate'}, result)
            end)
        end)
    end)
